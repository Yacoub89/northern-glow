...
const S = {
  ...
  sub: { color: "var(--admin-text-subtle)", fontSize: 14, margin: 0, maxWidth: 520, lineHeight: 1.5 },
  panel: { background: "var(--admin-surface)", border: "1px solid var(--admin-border)", borderRadius: 8, padding: 18 },
  invitePanel: { background: "var(--admin-surface)", border: "1px solid var(--admin-border)", borderRadius: 8, padding: 18, minWidth: 340 },
  ...
  memberCard: { background: "var(--admin-surface)", border: "1px solid var(--admin-border)", borderRadius: 8, padding: 16 },
  avatar: {
    width: 38,
    height: 38,
    borderRadius: "50%",
  ...
  detail: { color: "var(--admin-text-subtle)", fontSize: 12, marginTop: 14 },
