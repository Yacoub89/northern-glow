...
const S = {
  ...
  sub: { color: "var(--admin-text-subtle)", fontSize: 14, margin: 0, maxWidth: 540, lineHeight: 1.5 },
  ...
  day: { background: "var(--admin-surface)", border: "1px solid var(--admin-border)", borderRadius: 8, minHeight: 210, overflow: "hidden" },
  dayHead: { padding: "12px 13px", borderBottom: "1px solid var(--admin-border)", display: "flex", justifyContent: "space-between", gap: 8 },
  dayName: { fontSize: 13, fontWeight: 800, color: "var(--admin-text)" },
  dayDate: { fontSize: 12, color: "var(--admin-text-subtle)" },
  dayBody: { padding: 12, display: "grid", gap: 10 },
  classCard: { background: "var(--admin-surface)", border: "1px solid var(--admin-border)", borderRadius: 7, padding: 12 },
  classTop: { display: "flex", justifyContent: "space-between", gap: 10, alignItems: "flex-start", marginBottom: 8 },
  time: { color: "var(--admin-primary)", fontSize: 20, fontWeight: 800, lineHeight: 1 },
  capacity: { color: "var(--admin-text-subtle)", fontSize: 12, background: "var(--admin-bg)", border: "1px solid var(--admin-border-strong)", borderRadius: 4, padding: "3px 7px" },
  meta: { color: "var(--admin-text-muted)", fontSize: 13, marginTop: 5, overflowWrap: "anywhere" as const },
  wod: { color: "var(--admin-text)", fontSize: 13, marginTop: 9, fontWeight: 700, overflowWrap: "anywhere" as const },
  empty: { color: "var(--admin-text-subtle)", fontSize: 13, padding: "12px 0" },
