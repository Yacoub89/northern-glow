...
const S = {
  ...
  sub: { color: "#6b7280", fontSize: 14, margin: "0 0 22px", lineHeight: 1.5 },
  ...
  colorSwatch: (color: string) => ({
    width: 36, height: 36, borderRadius: 6, background: color, border: "2px solid #d1d5db",
  ...
  tzDropdown: {
    ...
    background: "#f8fafc", border: "1px solid #d1d5db", borderRadius: 8, marginTop: 4,
    maxHeight: 220, overflowY: "auto" as const, boxShadow: "0 8px 24px rgba(0,0,0,0.5)",
  },
  tzOption: (active: boolean) => ({
    padding: "9px 12px", fontSize: 13, cursor: "pointer",
    background: active ? "#eef2f7" : "transparent", color: active ? "#111827" : "#374151",
  }),
  logoArea: {
    display: "flex", alignItems: "center", gap: 16,
  },
  logoPreview: {
    width: 72, height: 72, borderRadius: 10, border: "1px solid #d1d5db",
    objectFit: "contain" as const, background: "#f8fafc",
  },
  logoPlaceholder: {
    width: 72, height: 72, borderRadius: 10, border: "1px dashed #d1d5db",
    background: "#f8fafc", display: "flex", alignItems: "center", justifyContent: "center",
    color: "#9ca3af", fontSize: 11,
  },
  uploadBtn: {
    padding: "8px 16px", borderRadius: 8, fontSize: 13, fontWeight: 500,
    cursor: "pointer", border: "1px solid #d1d5db", background: "#f8fafc", color: "#374151",
  },
  uploadHint: { fontSize: 11, color: "#9ca3af", marginTop: 4 },
  btn: {
    padding: "11px 24px", borderRadius: 8, fontWeight: 600, fontSize: 14,
    cursor: "pointer", border: "none", background: "#1BBFBF", color: "#062a2a",
  },
