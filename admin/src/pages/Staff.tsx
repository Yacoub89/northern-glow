...
const S = {
  ...
  invitePanel: { background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 8, padding: 18, minWidth: 430 },
  ...
  card: { background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 8, padding: 16 },
  ...
  badge: (tone: "admin" | "coach" | "active" | "inactive") => ({
    ...
    fontSize: 12,
    background:
      tone === "admin" ? "#1BBFBF22" : tone === "coach" ? "#FF9F0A22" : tone === "active" ? "#34C75922" : "#6b728022",
    color:
      tone === "admin" ? "#1BBFBF" : tone === "coach" ? "#FF9F0A" : tone === "active" ? "#34C759" : "#6b7280",
  }),
