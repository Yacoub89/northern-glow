...
const S = {
  ...
  eyebrow: { color: "var(--admin-primary-bright)", fontSize: 13, fontWeight: 700, marginBottom: 10 },
  h1: { fontSize: 24, fontWeight: 800, margin: "0 0 12px" },
  copy: { color: "var(--admin-text-muted)", fontSize: 15, lineHeight: 1.6, margin: "0 0 24px" },
  button: {
    width: "100%",
    padding: "12px 0",
    borderRadius: 8,
    border: "none",
    background: "var(--admin-primary-bright)",
