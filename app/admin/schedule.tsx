        ...
        <View style={s.col}>
          ...
          <View style={s.tableCard}>
            ...
            {wodSchedule.map(({ date, wod }) => (
              <View key={date} style={[s.tableRow, date === today && s.todayRow]}>
                <Text style={[s.cell, { flex: 1, color: date === today ? Colors.primary : Colors.text, fontWeight: date === today ? "700" : "400" }]}>
                ...
                <Pressable
                  style={[s.actionBtn, wod && s.editBtn]}
                  onPress={() => router.push({ pathname: "/wod-form", params: wod ? { wodId: wod._id } : { date } })}
                >
                  <Text style={[s.actionBtnText, wod && s.editBtnText]}>{wod ? "Edit" : "+ Add"}</Text>
                </Pressable>
              </View>
            ))}
          </View>
...
const s = StyleSheet.create({
  ...
  todayRow: { backgroundColor: Colors.primary + "0a" },
  ...
  editBtn: { borderColor: Colors.primary + "55", backgroundColor: Colors.primary + "11" },
